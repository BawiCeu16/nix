...
import 'package:nix/ui/screens/settings/controllers/playback_settings_controller.dart';
...
class _PlaybackSettingsPageState extends State<PlaybackSettingsPage> {
  late final PlaybackSettingsController _controller;

  @override
  void initState() {
    super.initState();
    _controller = PlaybackSettingsController();
  }
          ...
          body: ListView(
            ...
            children: [
              ...
              CardListTile(
                ...
                isFirst: true,
                onTap: () => _controller.toggleAutoPlay(settings),
              ),
              ...
              CardListTile(
                ...
                onTap: () => _controller.toggleSkipSilence(settings),
              ),
              const SizedBox(height: 2.5),
              CardListTile(
                ...
                onTap: () => _controller.toggleResetSpeedOnNewTrack(settings),
              ),
              const SizedBox(height: 2.5),
              CardListTile(
                ...
                trailing: Switch(
                  ...
                  onChanged: (value) =>
                      settings.setResumeFromPlayedDuration(value),
                ),
                isLast: true,
                onTap: () =>
                              ...
                              children: [
                                ...
                                IconButton(
                                  ...
                                  onPressed: () => _controller
                                      .resetUpNextIndicatorTime(settings),
                                ),
                              ],
                            ),
